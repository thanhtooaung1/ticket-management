...
@section('content')
    <div class="card col-md-8">
        <div class="card-header">
            <a href="{{ route('user.index') }}" class="btn btn-dark"><i class="fas fa-arrow-left"></i></a>
            Update User
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('user.update', $user->id) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="form-check col-md-6">
                        <input class="form-check-input" name="admin" type="checkbox" value="0" id="flexCheckChecked"
                            {{ $user->role == 0 ? 'checked' : '' }}>
